export type { ForwardSimulator, ITranSPORTmerSimulator } from '../types.js'
...
export function createForwardSimulator(type: 'mock' | 'gemini' | 'transportmer' = 'mock'): ForwardSimulator {
  switch (type) {
    case 'mock':
    ...
    case 'transportmer':
      return new TranSPORTmerSimulator() as unknown as ForwardSimulator
    default:
